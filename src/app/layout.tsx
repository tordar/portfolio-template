        ...
        <LayoutProvider>
            <div className="min-h-screen bg-white text-white flex flex-col gap-1 p-1">
                ...
                <div className="flex-1 grid grid-cols-1 md:grid-cols-10 grid-rows-none md:grid-rows-[repeat(9,1fr)] gap-1">
                    ...
                    <DynamicArea area="main" className="bg-gray-900 md:col-start-5 md:col-end-11 md:row-start-1 md:row-end-9 border-2 border-white" />
                    <div className="bg-gray-900 md:col-start-5 md:col-end-7 md:row-start-8 md:row-end-9 border-2 border-white">
                        <NavigationButtons />
                    </div>
                    <div className="bg-gray-900 md:col-start-5 md:col-end-8 md:row-start-9 md:row-end-10 border-2 border-white">
                        <DynamicArea area="bottomLeft" className="bg-gray-900 md:col-start-7 md:col-end-11 md:row-start-8 md:row-end-9" />
                    </div>
                    <div className="bg-gray-900 md:col-start-8 md:col-end-11 md:row-start-9 md:row-end-10 border-2 border-white">
                        <DynamicArea area="bottomRight" className="bg-gray-900 md:col-start-7 md:col-end-11 md:row-start-8 md:row-end-9" />
                    </div>
                </div>
            </div>
            {children}
